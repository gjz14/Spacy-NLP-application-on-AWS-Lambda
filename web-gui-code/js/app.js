...
const nerEndpoint = 'https://wz7zbzjr0i.execute-api.us-west-2.amazonaws.com/dev/ner';

// Endpoint URL for PoS tagging and dependency parsing
const parseEndpoint = 'https://o8xsax6zdk.execute-api.us-west-2.amazonaws.com/dev/parse'; 
